...
varremoveCartItemButtons = document.getElementsByClassName('btn-danger') 
...
updateCartTotal() 
}functionremoveCartItem(event) { 
Var buttonClicked = event.target 
buttonClicked.parentElement.parentElement.remove() 
updateCartTotal() 
}functionquantityChanged(event) { 
...
<button class="btnbtn-danger" type="button">REMOVE</button> 
</div>` 
